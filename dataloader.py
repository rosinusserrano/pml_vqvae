...
def load_data(dataset: str, transformation=None, n_train=None, n_test=None, num_workers=1):
    train_set = None
    test_set = None
    ...
    if dataset == "imagenet":
        train_set = ImageNet(DATASET_DIR + "imagenet_torchvision/data","train", transform=transformation)
        test_set = ImageNet(DATASET_DIR + "imagenet_torchvision/data","val", transform=transformation)

    elif dataset == "imagenet_mini":
        train_set = ImageNet(DATASET_DIR + "imagenet_torchvision/imagenet100","train", transform=transformation)
        test_set = ImageNet(DATASET_DIR + "imagenet_torchvision/imagenet100","val", transformat=transformation)
