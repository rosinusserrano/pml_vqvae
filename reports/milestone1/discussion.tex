...
While we still intend to work with CIFAR-10 for comparison, its lower capacity makes it less promising to us.
It does allow for faster prototyping.

While we assess that ImageNet is comparably smaller than current datasets used for commercially used models, it is
...
fidelity demonstrated by state-of-the-art image generation models.
