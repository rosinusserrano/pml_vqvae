\begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/imagenet_unnormalized}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/imagenet_sizes_errorbar}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/imagenet_sizes_histogram}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/cifar_rbatch}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/optima_shape_examples}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{../../sample_images/random_resized_crop_small}
